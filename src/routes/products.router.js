...
router.get('/realTimeProducts', jwtValidation, authMiddleware(['premium', 'admin']), productsController.realTimeProducts);
...
router.get('/productsAdmin', jwtValidation, authMiddleware(['premium', 'admin', 'user']), productsController.allProductsAdmin);
